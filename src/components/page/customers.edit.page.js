...
export class CustomersEditPage extends React.Component {
    ...
    componentDidMount() {
        if (this.props.match.params.id){
            getCustomer(this.props.match.params.id).then(data => {
                this.setState({customer: data, isLoaded: true, typeCreatePage: false, title: 'Edit Page'});
            })
        }else{
    ...
    render() {
        ...
        } else if (this.state.isLoaded && this.state.customer.FirstName === undefined) {
            return(
                    <>
                        ...
                        {({
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                />
                                {errors.TotalPurchasesAmount && touched.TotalPurchasesAmount && errors.TotalPurchasesAmount}
                                <button type="submit">
                                    Edit
                                </button>
                            </form>
